...
::grpc::Status Greeter::Stub::SayHello(::grpc::ClientContext* context, const ::example::HelloRequest& request, ::example::HelloResponse* response) {
...
void Greeter::Stub::async::SayHello(::grpc::ClientContext* context, const ::example::HelloRequest* request, ::example::HelloResponse* response, std::function<void(::grpc::Status)> f) {
...
void Greeter::Stub::async::SayHello(::grpc::ClientContext* context, const ::example::HelloRequest* request, ::example::HelloResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::example::HelloResponse>* Greeter::Stub::PrepareAsyncSayHelloRaw(::grpc::ClientContext* context, const ::example::HelloRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::example::HelloResponse>* Greeter::Stub::AsyncSayHelloRaw(::grpc::ClientContext* context, const ::example::HelloRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
Greeter::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< Greeter::Service, ::example::HelloRequest, ::example::HelloResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Greeter::Service* service,
...
::grpc::Status Greeter::Service::SayHello(::grpc::ServerContext* context, const ::example::HelloRequest* request, ::example::HelloResponse* response) {
  (void) context;
  (void) request;
  (void) response;
